...
const SUBJECT_OVERRIDES = {
  ...
  'the-24-hour-micro-offer':
    'A clean geometric illustration of a minimalist circular 24-hour clock face on the left, with a compact gift-box-like product shape emerging along an arrow toward a simple checkout tag or coin on the right. A subtle spark or circuit motif inside the clock hints at AI assistance. Conceptual visual metaphor for building a small sellable offer in a single day and letting buyers validate it.',
